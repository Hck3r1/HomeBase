...
export function SocialProviderIcon({ provider }: { provider: Provider }) {
  switch (provider) {
    ...
    case 'facebook':
      return (
        <Svg width={SIZE} height={SIZE} viewBox="0 0 24 24" accessibilityRole="image" accessibilityLabel="Facebook">
          <Path
            fill="#1877F2"
    ...
    case 'x':
      return (
        <Svg width={SIZE} height={SIZE} viewBox="0 0 24 24" accessibilityRole="image" accessibilityLabel="X">
          <Path
            fill="#000000"
